...
from processor import html_to_markdown, is_own_digest_entry
...
class TestIsDailyNewsletterEntry:
    ...
    def test_normal_entry(self):
        ...
        assert not is_own_digest_entry(entry)
    ...
    def test_meta_headers_newsletter(self):
        ...
        assert is_own_digest_entry(entry)
    ...
    def test_title_contains_daily_keyword(self):
        entry = {
            "title": "News Agent 每日精选 | 2026-07-18",
