...
- **Main Project Overview & Quickstart:** Refer to the main [README.md](../README.md).
- **AI Agent Guidelines:** Refer to [AGENTS.md](../AGENTS.md).
- **Interactive API Documentation:** Available at `http://127.0.0.1:12301/docs` when running `news-agent serve`.
