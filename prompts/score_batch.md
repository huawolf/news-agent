...
2. **用户兴趣匹配分 (`interest_score` 0-100)**：
   ...
   - 对“有潜力的 AI 应用”给予明确加权：包括新发布 AI 产品、AI 原生工作流、Agent 应用、能显著提升效率的垂直 AI 工具、已有用户/投票/收入/增长信号的 AI 创业项目。即使来源是 Product Hunt、App Store、Reddit、GitHub 或社区讨论，只要显示出可落地产品机会或早期增长潜力，`interest_score` 应优先评为 85+。
3. **最终总分 (`score` 0-100)**：
