...
from src.storage import extract_section, get_last_push_file
...
<nav class=\"tabs\"><button class=\"tab active\" data-tab=\"settings\" onclick=\"openTab('settings')\" data-t=\"settings\">Settings</button><button class=\"tab\" data-tab=\"headlines\" onclick=\"openTab('headlines')\" data-t=\"headlines\">Headlines</button><button class=\"tab\" data-tab=\"sources\" onclick=\"openTab('sources')\" data-t=\"sources\">Sources</button><button class=\"tab\" data-tab=\"logs\" onclick=\"openTab('logs')\" data-t=\"logs\">Logs</button></nav>
...
<div id=\"sources\" class=\"tab-panel\"><section><h2 data-t=\"addSources\">Add news sources</h2><p data-t=\"sourceHint\">Paste one RSS or Atom feed URL per line. Each URL is checked before it is added.</p><textarea id=\"sourceUrls\" rows=\"7\" placeholder=\"https://example.com/feed.xml\"></textarea><div class=\"actions\"><button onclick=\"addBulkSources()\" data-t=\"verifyAdd\">Verify and add sources</button></div><div id=\"sourceResults\" class=\"source-results\"></div></section><section><h2 data-t=\"currentSources\">Current news sources</h2><p data-t=\"currentSourcesHint\">RSS feeds plus built-in signal sources.</p><input id=\"sourceSearch\" oninput=\"renderSources()\" data-t-placeholder=\"search\" placeholder=\"Search sources\"><div id=\"sourceList\" class=\"source-list\"></div></section></div>
<div id=\"headlines\" class=\"tab-panel\"><div id=\"headlinesOutput\"><section><p class=\"hint\" data-t=\"headlinesEmpty\">No generated headlines yet.</p></section></div></div>
        ...
        return {
            ...
            "integrations": [
                ...
                *[
                    {
                        **source,
                        "enabled": bool(config.get("sections", {}).get("signals", {}).get("enabled", False))
